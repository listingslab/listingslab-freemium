...
<style>
	...
	.ui-widget-content {border: 2px solid <?php print $ui ['border'];?>;}
	.ui-widget-header {border: 2px solid <?php print $ui ['border'];?>;}
	.ui-state-default,.ui-widget-content .ui-state-default,.ui-widget-header .ui-state-default {border: 2px solid <?php print $ui ['border'];?>;}
	.ui-state-hover,.ui-widget-content .ui-state-hover,.ui-widget-header .ui-state-hover,.ui-state-focus,.ui-widget-content .ui-state-focus,.ui-widget-header .ui-state-focus {border: 2px solid <?php print $ui ['border'];?>;}
	.ui-state-active,.ui-widget-content .ui-state-active,.ui-widget-header .ui-state-active {border: 2px solid <?php print $ui ['border'];?>;}
	.ui-state-highlight,.ui-widget-content .ui-state-highlight,.ui-widget-header .ui-state-highlight {border: 2px solid <?php print $ui ['border'];?>;}
	.ui-state-error,.ui-widget-content .ui-state-error,.ui-widget-header .ui-state-error {border: 2px solid <?php print $ui ['border'];?>;}
